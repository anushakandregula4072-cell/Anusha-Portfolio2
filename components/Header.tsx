        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <NavLink to="/experience" className={navLinkClasses}>Experience</NavLink>
      ...
      {isOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <NavLink to="/portfolio" className={navLinkClasses} onClick={() => setIsOpen(false)}>Portfolio</NavLink>
            <NavLink to="/experience" className={navLinkClasses} onClick={() => setIsOpen(false)}>Experience</NavLink>
